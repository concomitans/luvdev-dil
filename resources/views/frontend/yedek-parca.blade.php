...
@section('meta')
    ...
    <title>Luvian Machinery | Yedek Parçalar</title>
@endsection
@section('content')
    <div class="proje-kategorileri">
        <div class="container">
            ...
            <div id="portfolio" class="util-carousel portfolio-list">
                ...
                <div class="item text-center">
                    <div class="meida-holder">
                        <a href="pecete-grubu"><img src="uploads/photos/proje-kategori/premium_10x10.png" class="img-responsive center-block" alt=""/></a>
                    </div>
                    <div class="detail-container col-md-12">
                        <a href="pecete-grubu">Peçete Üretim Makinaları</a>
                    </div>
                </div>
                <div class="item text-center">
                    <div class="meida-holder">
...
@section('js')
<script>
    const titles = ["Luvian Machinery", "Yedek Parçalar", "Kaliteli Hizmet"];
    let index = 0;
    setInterval(() => {
