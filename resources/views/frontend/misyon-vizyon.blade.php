...
@section('meta')
    ...
    <title>Luvian Machinery | Misyon & Vizyon</title>
@endsection
@section('content')
...
<div class="col-md-8 col-md-offset-1 sayfa-icerik">
    ...
    <p>
    Sektör ihtiyaçlarının çözümüne yönelik katma değeri yüksek, güvenilir ve kaliteli ürünlerin tedariğini sağlamak, ihracat potansiyelini arttırarak ülke ekonomisine katkıda bulunan, toplumsal evrensel ve çevresel değerlere bağlı bir kuruluş olmak.
    </p>
