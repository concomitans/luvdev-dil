...
@section('meta')
    <meta name="description" content="Haberler Açıklama">
    <meta name="keywords" content="Kurumsal Anahtar Kelimeler">
    <title>Luvian Machinery | Haberler</title>
@endsection
@section('content')
    ...
    <div class="container">
    <ol class="breadcrumb">
        <li><a href="haberler">fuarlar</a></li>
    ...
    <div class="container">
        <div class="col-md-3 sidebar-baslik">
            ...
            <ul>
                <li class="passive"><a href="fuarlar">Fuarlar</a></li>
